...
import 'package:theraman/src/features/dashboard/presentation/executive/controller/cancel_session_controller.dart';
...
class CancelSessionScreen extends StatelessWidget {
  ...
  final cancelSessionController = CancelSessionController();
          ...
          children: [
                  ...
                  data: (value) {
                    ...
                    return DropdownButtonFormField<Reasons>(
                        ...
                        onChanged: (newValue) {
                          ...
                          print("reason value===${reasonValue.value}");
                        });
                  });
            }),
            gapH12,
            ...
            DropdownButtonFormField<String>(
              ...
              onChanged: (newValue) {
                ...
                print("adjustable value==${adjustableValue.value}");
              },
            ),
            gapH16,
            Consumer(builder: (context, ref, _) {
              return CancelSessionButton(onSubmit: () {
                ...
                cancelSessionController.cancelSession(
                    ref: ref,
